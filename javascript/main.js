...
(function ($) {
  ...
  var responsiveMenu = function () {
    ...
    $(window).on("load resize", function () {
      ...
      if (currMenuType !== menuType) {
        ...
        if (currMenuType === "mobile") {
          ...
          hasChildMenuMega
            .find("h3")
            .append('<span class="btn-submenu-child"></span>');
    ...
    $(document).on(
      "click",
      "#mainnav-mobi li.has-mega-menu .row .btn-submenu-child",
      function (e) {
        $(this)
          .toggleClass("active")
          .parent("h3.cat-title")
  ...
  var responsiveMenuMega_S2 = function () {
    ...
    $(window).on("load resize", function () {
      ...
      if (currMenuType !== menuType) {
        ...
        if ($("body").hasClass("grid")) {
          if (currMenuType === "mobile") {
            var $mobileMenuMegaV2 = $("#mega-menu")
              .attr("id", "mega-mobile")
              .hide();
            ...
            ChildMenuMegaV2.append(
              '<div class="btn-menu-mega"><span></span></div>'
            );

            $(".drop-menu").hide();
            $mobileMenuMegaV2
              .find(".dropdown")
              .append('<span class="btn-dropdown"></span>');

            ChildDropmenuV2.children("ul").hide();
            $(".drop-menu")
              .find(".cat-title")
              .append('<span class="btn-dropdown-child"></span>');
          } else {
            var $desktopMenuMegaV2 = $("#mega-mobile")
              .attr("id", "mega-menu")
              .removeAttr("style");
    ...
    $(document).on(
      "click",
      "#mega-mobile ul.menu li a .btn-dropdown",
      function (e) {
        $(this)
          .toggleClass("active")
          .closest("li")
    ...
    $(window).on("load resize", function () {
      ...
      if (currMenuType !== menuType) {
        ...
        if (currMenuType === "mobile") {
          ...
          var $desktopMenuMega = $("#mega-mobile")
            .attr("id", "mega-menu")
            .removeAttr("style");
  ...
  var CountDown_s2 = function () {
    var before = '<div class="square"><div class="numb">',
      ...
      textsec = '</div><div class="text">SECS';
    if ($().countdown) {
      $(".counter.style1.v1 .counter-content .count-down").countdown(
        "2020/12/20",
        function (event) {
          $(this).html(
            event.strftime(
    ...
    $(".flat-product-content.style2").each(function () {
      ...
      $(this)
        ...
        .on("click", function (e) {
          ...
          $(this).addClass("active").siblings().removeClass("active");
          $(this)
            .closest(".flat-product-content.style2")
            .find(".col-md-12")
            .children("div.row")
            .eq(liActive)
            .fadeIn(1000)
  ...
  var toggleLocation = function () {
    $(".location .location-content .select-location select").on(
      "click",
      function () {
        $(this).toggleClass("active");
        $(this)
          .closest(".location-content")
          .children("ul.location-list")
          .slideToggle(300);
      }
    );
  }; // Toggle Location
  ...
  var googleMap_s2 = function () {
    var data = JSON.parse(
      '[{"address":"Quận Bradford, Florida","content":"","status":"live"},{"address":"Quận Bibb, Georgia","content":""},{"address":"Wateree Swamp, Nam Carolina","content":""}]'
    );
  ...
  $(".btn-up").click(function (e) {
    ...
    var inc_value = $(this).closest(".quanlity").find(".qty-input").val();
    var value = parseInt(inc_value, 10);
    value = isNaN(value) ? 0 : value;
    if (value < 10) {
      value++;
      $(this).closest(".quanlity").find(".qty-input").val(value);
    }
  });
  ...
  $(".btn-down").click(function (e) {
    ...
    var dec_value = $(this).closest(".quanlity").find(".qty-input").val();
